;;; purify.el --- Purify Theme
;;  Clean & vibrant color schemes for emacs

;; base on dracula-theme.el --- Dracula Theme (https://github.com/dracula/emacs/blob/master/dracula-theme.el)
...
(let ((colors '((fg1          "#FAFAFA")      ; Assigment form: VARIABLE COLOR [TTY-COLOR]
                (fg2          "#FAFAFA")
                (fg3          "#FAFAFA")
                (fg4          "#FAFAFA")
                (bg1          "#252834" "#000000")
      ...
      (faces '(;; default
               ...
               (web-mode-html-attr-name-face :foreground ,keyword)
...
(provide-theme 'purify)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; purify-theme.el ends here
